...
*/
stm_word_t *get_lock_aux(volatile stm_word_t *addr) _CALLCONV;
...
int is_locked(volatile stm_word_t *addr) _CALLCONV;

void atomic_store_release_aux (stm_word_t* orec, stm_word_t commit_timestamp) _CALLCONV;

stm_word_t atomic_load_acquire(stm_word_t* lock) _CALLCONV;
