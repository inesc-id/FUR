...
static inline void int_stm_store_u8(volatile uint8_t *addr, uint8_t value);
static inline void int_stm_store_u16(volatile uint16_t *addr, uint16_t value);
static inline void int_stm_store_u32(volatile uint32_t *addr, uint32_t value);
static inline void int_stm_store_u64(volatile uint64_t *addr, uint64_t value);
static inline uint8_t int_stm_load_u8(volatile uint8_t *addr);
static inline uint16_t int_stm_load_u16(volatile uint16_t *addr);
static inline uint32_t int_stm_load_u32(volatile uint32_t *addr);
static inline uint64_t int_stm_load_u64(volatile uint64_t *addr);
