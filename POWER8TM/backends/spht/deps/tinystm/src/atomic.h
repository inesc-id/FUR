...
#  define ATOMIC_CB                     __sync_synchronize()
// #  define ATOMIC_CAS_FULL(a, e, v)      (__sync_val_compare_and_swap((volatile AO_t *)(a), (AO_t)(e), (AO_t)(v)))
#  define ATOMIC_FETCH_INC_FULL(a)      (__sync_fetch_and_add((volatile AO_t *)(a), 1))
#  define ATOMIC_FETCH_DEC_FULL(a)      (__sync_fetch_and_sub((volatile AO_t *)(a), 1))
#  define ATOMIC_FETCH_ADD_FULL(a, v)   (__sync_fetch_and_add((volatile AO_t *)(a), (AO_t)(v)))
#  ifdef SAFE
...
#   define ATOMIC_LOAD_ACQ(a)           (__atomic_load_n((volatile AO_t *)(a), __ATOMIC_ACQUIRE))
#   define ATOMIC_LOAD(a)               (__atomic_load_n((volatile AO_t *)(a), __ATOMIC_ACQUIRE))
#   define ATOMIC_STORE_REL(a, v)       (__atomic_store_n((volatile AO_t *)(a), (AO_t)(v), __ATOMIC_RELEASE))
#   define ATOMIC_STORE(a, v)           (__atomic_store_n((volatile AO_t *)(a), (AO_t)(v), __ATOMIC_RELEASE))
#   define ATOMIC_MB_READ               AO_nop_full()
#   define ATOMIC_MB_WRITE              AO_nop_full()
#   define ATOMIC_MB_FULL               AO_nop_full()
#  else /* ! SAFE */
