...
for f in files:
	...
	for line in f:
		...
		if "time" in line and "total" not in line:
		...
		elif "explicit aborts" in line and "rot" not in line:
			...
			rot_commits = float(line.split(" ")[-1])
                ...
                elif "rot explicit aborts" in line:
